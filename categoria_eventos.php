...
<?php if(isset($_SESSION['nombre'])){?>
	<div class="page-wrapper">
		...
		<div class="titulo_evento"><h2>Tipos de eventos</h2></div>
				...
				<li class="celdaEditar" >
					<div class="row">
						<div class="celdaDef pequena">
							<input type="text" class="inputFull" name="nombrTipoEditar" id="nombreTipoEvento" />
						</div>
...
<script type="text/javascript" src="scripts/crearTipoEvento.js"></script>
<?php } else {	?>
	<div class="main">
